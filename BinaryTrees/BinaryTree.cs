...
namespace BinaryTrees
{
    public class BinaryTree<T> : IEnumerable<T> where T : IComparable
    {
        ...
        private int weight = 1;            // Номер элемента
        ...
        // Рекурсивный обход бинарного дерева для IEnumerable<T>
        private IEnumerator<T> EnumeratorNode(BinaryTree<T> root)
        {
            // Не инициализирован
        ...
        public T this[int i]
        {
            get
            {
                ...
                while (true)
                {
                    ...
                    int currentNodeIndex = (current.leftSon == null ? 0 : current.leftSon.weight) + parentWeight;
